...
- Highlights should use deterministic accent colors in v0. Branch edges and child branch nodes inherit the source highlight color so the visual path stays traceable without adding a color-picker workflow yet.
